...
gsap.to("#page>video", {
  scrollTrigger: {
    trigger: "#page>video",
    start: "top 80%", // Start playing when 80% of the video is visible
    end: "bottom top", // Stop when video leaves the viewport
    scroller: "#main",
    onEnter: () => {
      document.querySelector("#page>video").play();
    },
    onLeave: () => {
      document.querySelector("#page>video").pause();
    },
    onEnterBack: () => {
      document.querySelector("#page>video").play();
    },
...
// Pin the page with smooth scroll
gsap.to("#page", {
  scrollTrigger: {
    trigger: "#page",
    start: "top top",
...
// Fade out the #page-bottom element as you scroll
gsap.to("#page-bottom", {
  scrollTrigger: {
    trigger: "#page-bottom",
    start: "5% top", // Starts fading out when 30% of the element is in view
    end: "bottom top",
    scroller: "#main",
    scrub: true, // Smooth transition as you scroll
  },
  opacity: 0, // Fades out to 0 opacity
});
